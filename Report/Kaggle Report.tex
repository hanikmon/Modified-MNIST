...
\begin{itemize}
	\item \textbf{Thresholding: } The idea of thresholding is very simple. If the color bit values of any pixel is greater than a certain number, then the pixel will be 1 (representing white or 255), otherwise it will be 0 (representing black or 0).
